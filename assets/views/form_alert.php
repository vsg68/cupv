<div class='user-form ui-widget ui-corner-all box-shadow'>
	<div class="ui-state-highlight ui-corner-all" style="padding: 0 .7em;">
		<p><span class="ui-icon ui-icon-<?= isset($errorMsg) ? 'error' : 'alert' ?>" style="float: left; margin-right: .3em;"></span></p>
	...
	<div class='alert-msg'>
	   ...
	   <?php } else {
				echo "<p>Эти адреса при необходимости нужно удалить вручную! </p>";
