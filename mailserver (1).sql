...
--
-- Хост: localhost
-- Время создания: Дек 03 2013 г., 15:06
...
DECLARE sdomain, ddomain VARCHAR(100);
...
IF dmail IS NULL THEN
	...
	SELECT domain_name, delivery_to FROM domains WHERE active=1 AND domain_type=1 AND domain_name=SUBSTRING(incmail, INSTR(incmail, '@')+1) LIMIT 1 INTO sdomain, ddomain;	
	IF ddomain IS NOT NULL THEN
		
		SELECT delivery_to FROM aliases WHERE active = 1 AND alias_name = REPLACE(incmail, sdomain, ddomain)
		UNION
		SELECT mailbox as delivery_to FROM users WHERE active = 1 AND mailbox = REPLACE(incmail, sdomain, ddomain);
	ELSE
		SELECT delivery_to FROM aliases WHERE active = 1 AND alias_name = incmail;
	END IF;
ELSE
...
INSERT INTO `aliases` (`id`, `alias_name`, `delivery_to`, `alias_notes`, `active`) VALUES
(1, 'admin@t1.gmpro.ru', 'admin@t1.gmpro.ru', '', 1),
...
(7, 'amt@gmp.ru', 'amt@zimbra.gmp.ru', 'test', 1),
...
(13, 'ann@gmpro.ru', 'ann@gmpro.ru', '????? ???', 1),
...
(20, 'maxx@gmpro.ru', 'maxx@zimbra.gmp.ru', '', 1),
...
(25, 'dar@gmpro.ru', 'dar@zimbra.gmp.ru', '', 0),
...
(56, 'star@gmpro.ru', 'star@gmpro.ru', NULL, 0),
...
(79, 'alex.teplitsky@gmpro.ru', 'prosto@t1.gmpro.ru', 'test oloias 22', 1),
...
(84, 'eruvil08@gmpro.ru', 'eruvil089@gmpro.ru', '', 1),
(86, 'admin@gmpro.ru', 'adminOOOO@gmpro.ru', '', 1),
(97, 'dddd@gmpro.ru', 'dddd11111@gmpro.ru', '', 1),
(102, 'maxx@gmpro.ru', 'maxx1@gmpro.ru', NULL, 1),
(107, 'vsg@gmpro.ru', 'oivaschenko@gmpro.ru', 'test', 1),
(110, 'new@gmpro.ru', 'vbufet@gmpro.ru', '?????', 1),
(111, 'vsg@gmpro.ru', 'gkv@gmpro.ru', '????????? ?????????????', 1),
(112, 'eruvil08@gmpro.ru', 'eruvil088@gmpro.ru', NULL, 1);
...
INSERT INTO `domains` (`id`, `domain_name`, `delivery_to`, `domain_type`, `domain_notes`, `all_enable`, `all_email`, `active`) VALUES
(2, 'gmpro.ru', 'virtual', 0, 'Основной домен', 0, 'all.gmpro@gmpro.ru', 1),
(4, 'gazmetallproekt.ru', 'gmpro.ru', 1, 'Domain Split Config', 0, NULL, 1),
(5, 'eruvil.ru', 'virtual', 0, 'Домен для ООО "Эрувиль" (на ЗВИ)', 0, 'pipsodent@eruvil.ru', 1),
(6, 'novoroscement.ru', 'smtp:[10.1.100.64]', 2, 'Почтовый сервер ОАО "Новоросцемент" (через VPN)', 0, NULL, 0),
(7, 'zimbra.gmp.ru', 'smtp:[192.168.0.252]', 2, NULL, 0, NULL, 1),
(8, 'bgmt.ru', 'smtp:[192.168.0.252]', 2, 'СФ', 0, NULL, 1),
(9, 'nv-tr.ru', 'smtp:[192.168.0.252]', 2, 'ыыы', 0, NULL, 1),
(20, 'some1.com', 'gmpro.ru', 1, NULL, 0, NULL, 1),
(21, 's1.ru', 't1.gmpro.ru', 1, '', 0, NULL, 1),
(23, 'bbb.ru', 't1.gmpro.ru', 1, '', 0, NULL, 1),
(24, 't1.gmpro.ru', 'virtual', 0, '', 0, 'aall@gmpro.ru', 1),
(25, 'test.ru', 'virtual', 0, 'Просто временный домен', 0, '@test.ru', 1),
(26, 'next_test.ru', 'virtual', 0, 'Next test', 0, '@next_test.ru', 1),
(27, 'd2.ru', 'virtual', 0, 'следующий домен', 1, 'some@d2.ru', 1),
(28, 'd3.ru', 'virtual', 0, '3', 0, '', 1),
(29, 'd4.ru', 'virtual', 0, 'просто 4', 1, 'some@d4.ru', 1),
(30, 'd5.ru', 'virtual', 0, 'some5 domaijn', 1, 'domain5@d5.ru', 1),
(31, 'duval.ru', 'smtp:[1.1.1.2]', 2, 'простой транспорт', 0, NULL, 0),
(32, 'duval.ru', 'smtp:[1.1.1.3]', 2, '', 0, NULL, 0),
(33, 'duval.com', 'd:[1.2.3.4]', 2, 'samduval', 0, NULL, 1);
...
INSERT INTO `groups` (`id`, `name`, `note`, `active`) VALUES
(1, 'G1', '1', 1);
...
INSERT INTO `lists` (`id`, `user_id`, `group_id`) VALUES
(17, 3, 1),
(18, 7, 1);
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `acl_groups` int(11) DEFAULT NULL,
...
INSERT INTO `users` (`id`, `username`, `mailbox`, `password`, `md5password`, `path`, `imap_enable`, `allow_nets`, `acl_groups`, `active`) VALUES
...
(3, 'Konstantin V. Gaidukov', 'gkv@gmpro.ru', '', '757341fba0b515f42eb197083d0b2bf8', NULL, 1, '192.168.0.0/24, 127.0.0.1/32, 192.168.109.10/32', 0, 1),
...
(41, 'Account for mail backup from relay', 'mailcopy@gmpro.ru', 'iaibRvQ1945lfj', 'dfd49c9254bf101a9f1289fc9b0d3fa2', NULL, 1, '192.168.0.0/24,66', NULL, 0),
...
(47, 'Alexander V. Oslopov', 'oav@gmpro.ru', 'so1Xomi', '78b0488b177b1ef50d6f26d94ef78f55', '', 0, '192.168.0.0/24', NULL, 1),
...
(77, 'Aleksandr V. Matuhin', 'maxx@gmpro.ru', '9564371', '9091fd80834695b8c696adf3b6f20d55', '', 0, '192.168.0.0/24', NULL, 1),
...
(96, '(ERUVIL.RU)', 'eruvil08@gmpro.ru', 'abc154HPx', 'd2cf55626b0f8819644640bcd7056bac', '', 1, '192.168.0.0/24, 192.168.12.0/24,10.0.0.0/8', NULL, 1),
(97, 'Гордюнин Владимир Сергеевич', 'vsg@gmpro.ru', '', 'd3f427fbda2ec2b435b119c022bec1f2', NULL, 1, '192.168.0.0/24,127.0.0.1', 0, 1),
...
(119, 'dudu', 'didu@gmpro.ru', 'JMh6J8Z', 'd39fa8959eaa500ef39d6e6092d5da22', '', 1, '192.168.0.0/24', NULL, 1),
(125, 'pipo', 'pipo@gmpro.ru', 'wGYB75v', '649093e64b7cccdd081eb07697c75174', '', 1, '192.168.0.0/24', NULL, 1),
(128, 'wwww', 'www@gmpro.ru', '2sVt0XA', '14fedf93193ba92b2a25720c6c82f932', '', 1, '192.168.0.0/24', NULL, 1);

--
-- Триггеры `users`
--
DROP TRIGGER IF EXISTS `del_lists`;
DELIMITER //
CREATE TRIGGER `del_lists` AFTER DELETE ON `users`
 FOR EACH ROW delete from users_lists where users_id = id
//
DELIMITER ;
...
INSERT INTO `users_lists` (`id`, `lists_id`, `users_id`) VALUES
(3, 0, 0),
(4, 1, 78),
(8, 2, 71),
(9, 2, 77),
